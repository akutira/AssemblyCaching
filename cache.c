...
void cache_init(int blockSize, int numSets, int blocksPerSet)
{
    ...
    int offsetB = log2(blockSize);
    int setIndB = log2(numSets);
    int tagBit = 32 - offsetB - setIndB;


    int cacheSize = blockSize * blocksPerSet * numSets; 
    int cacheBlCount = numSets * blocksPerSet; 
...
//blocksperset is ways/associativity
/*
